...
class JogoBase:
    def __init__(self):
        ...
        self.Sergio_cinemons = [
            CInemon("Leao", "ESPECIAL", 15, 20, [("Dano Imoral", 30), ("Chama", 40)]),
            CInemon("Serpython", "ESPECIAL", 15, 20, [("Dano Imoral", 30), ("Chama", 40)]) ##### se liga
        ]
            ...
            if tile and tile_x == x and tile_y == y:
                if self.cracha_completo == 1:
                    ...
                    if propriedades and propriedades.get("porta", False):
                        ...
                        spawn_x = 950  # Posição de spawn (opcional)
                        spawn_y = 450
