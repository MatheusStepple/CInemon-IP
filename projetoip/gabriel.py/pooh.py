...
class Inimigo:
    def __init__(self, x, y, nome):
        ...
        if nome == 'Pedro':
            self.cor = VERMELHO
            self.imagem = pygame.image.load(r"C:\Users\gmome\Downloads\pedro.manhas.jpeg")
            self.imagem = pygame.transform.scale(self.imagem, (40, 60))
        elif nome == 'pooh':
            self.cor = VERDE
            self.imagem = pygame.image.load(r"C:\Users\gmome\Downloads\pooh.png")
            self.imagem = pygame.transform.scale(self.imagem, (40, 60))
        elif nome == 'Gusto':
            self.cor = LARANJA
        else:
...
class Jogo:
    def __init__(self):
        self.mensagens_introducao = ['Ola me chamo gabigol e vou ajudar voce nessa luta contra pedro noites',
                                     'encare essa jornada cmg e filipe milk' ]
        self.indice_mensagem_intro = 0 
        self.imagem_introducao = pygame.image.load(r"C:\Users\gmome\Downloads\ChatGPT Image 28 de mar. de 2025, 23_26_18.png")
        self.imagem_introducao = pygame.transform.scale(self.imagem_introducao, (LARGURA, ALTURA))
        self.estado = "menu"
        # Carrega o mapa TMX
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                if evento.key == pygame.K_RETURN and len(self.cinemons_escolhidos) == 3:
                    ...
                    self.indice_mensagem_intro = 0
                    self.aguardando_espaco = 0
                    return
    def renderizar_introducao(self):
        tela.fill(AZUL_ESCURO)
        tela.blit(self.imagem_introducao, (0, 0))
        # Desenhar caixa de diálogo
        pygame.draw.rect(tela, BRANCO, (50, ALTURA - 250, LARGURA - 100, 200))
        pygame.draw.rect(tela, PRETO, (50, ALTURA - 250, LARGURA - 100, 200), 2)
        
        # Renderizar texto atual
        texto = fonte.render(self.mensagens_introducao[self.indice_mensagem_intro], True, PRETO)
        tela.blit(texto, (70, ALTURA - 230))
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN and evento.key == pygame.K_SPACE:
                self.indice_mensagem_intro += 1
                if self.indice_mensagem_intro >= len(self.mensagens_introducao):
                    self.estado = "mapa"  # Vai para o mapa após todas as mensagens
    ...
    def rodar(self):
        while True:
            ...
            elif self.estado == "introducao":  # Novo estado
